package tv.purple.monolith.features.updater.data.mvp
...
import tv.purple.monolith.core.util.NetUtil.getFileSize
...
class UpdaterPresenter(
    ...
    private fun tryDownloadFile(updateData: UpdateData) {
        view.startDownloadService(updateData.url, updateData.build)
    }
}