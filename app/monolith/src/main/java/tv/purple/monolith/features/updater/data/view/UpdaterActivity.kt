package tv.purple.monolith.features.updater.data.view
...
import tv.purple.monolith.core.util.ViewUtil.setContentView
import tv.purple.monolith.features.updater.component.data.model.UpdateData
import tv.purple.monolith.features.updater.data.mvp.UpdaterContract
import tv.purple.monolith.features.updater.data.mvp.UpdaterPresenter
...
class UpdaterActivity : AppCompatActivity(), UpdaterContract.View {
    ...
    override fun render(state: UpdaterContract.View.State) {
        ...
        when (state) {
            ...
            is UpdaterContract.View.State.Loaded -> {
                ...
                actionButtonBtn.text = "orange_updater_update_action".fromResToString()
            ...
            is UpdaterContract.View.State.DownloadComplete -> {
                ...
                actionButtonBtn.text = "orange_updater_install_action".fromResToString()
            ...
            is UpdaterContract.View.State.Error -> {
                errorMsgTv.text = "orange_updater_error_msg".fromResToString(state.msg)
            ...
            is UpdaterContract.View.State.Downloading -> {
                ...
                downloadProgressDataTv.text = "orange_updater_ds2".fromResToString(
                    Formatter.formatFileSize(this, state.downloaded.toLong()),
                    Formatter.formatFileSize(this, state.total.toLong())
                )
                downloadProgressProcTv.text = "orange_updater_ds3".fromResToString(
                    state.progress
                )
    ...
    private fun bindData(data: UpdateData) {
        ...
        downloadSizeTv.text = "orange_updater_ds".fromResToString(
            if (data.size > 0) {
...
//        return Updater.get().getOtaFile(build)
    ...
    override fun installApk(file: File) {
        PackageHelperUtil.installApk(applicationContext, file)
    }

    override fun canInstallApk(): Boolean {
        return PackageHelperUtil.canInstallApk(applicationContext)
    }
    ...
    override fun openDiscord() {
        CoreUtil.openUrl(applicationContext, DISCORD_URL)
    }

    override fun openTg() {
        CoreUtil.openUrl(applicationContext, TG_URL)
    }

    override fun startDownloadService(url: String, build: Int) {
        DownloadAndInstallApk.cancelDownloading(applicationContext)
        DownloadAndInstallApk.startService(this, url, build)
    }
    ...
    companion object {
        ...
        private const val DISCORD_URL = "https://discord.com/invite/fwr2NsP78g"
